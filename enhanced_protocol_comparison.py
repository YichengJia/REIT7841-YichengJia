...
def print_detailed_comparison(results):
    ...
    print(f"   {'-'*25} {'-'*15} {'-'*15}")
    print(f"   {'Async Update Support':<25} {'No':<15} {'Yes':<15}")
    print(f"   {'Adaptive Weighting':<25} {'No':<15} {'Yes':<15}")
    print(f"   {'Smart Staleness Handling':<25} {'No':<15} {'Yes':<15}")
    print(f"   {'Dynamic LR Adjustment':<25} {'No':<15} {'Yes':<15}")
    print(f"   {'Network Interruption Tolerance':<25} {'No':<15} {'Yes':<15}")
